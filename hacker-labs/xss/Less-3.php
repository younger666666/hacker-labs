...
if (isset($_GET['submit'])) {
    ...
    if (empty($_GET['name'])) {
        $html = "<p class='alert alert-danger'>你不知道？</p>" . PHP_EOL;
    } else if($_GET['name']==='汤姆'){
        $html = "<p class='alert alert-success'>是的，这是{$_GET['name']}</p>" . PHP_EOL;
    } else {
        $html = "<p class='alert alert-success'>怎么可能是{$_GET['name']}</p>" . PHP_EOL;
	}
}
?>
<!DOCTYPE html>
...
<body>
	<div class="container mt-5">
		<form method="get" class="col-md-6 offset-md-3">
			<h1 class="text-center">欢迎来到Less-3</h1>
			<h2 class="text-center">你看过猫和老鼠？他是谁？</h2>
			<center>
				<img src="汤姆.jpg" alt="" width="250" height="250">
			</center>
			<div class="form-group">
				<label for="name-input">他叫什么名字？</label>
